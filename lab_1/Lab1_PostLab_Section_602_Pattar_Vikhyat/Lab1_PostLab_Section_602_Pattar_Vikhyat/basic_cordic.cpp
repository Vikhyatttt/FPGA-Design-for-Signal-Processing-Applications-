...
Hint:
	Step 1: Set the proper value for x0, y0, z0
	Step 2: Use the equation in the manual to iteratively update xk, yk, zk
	Step 3: Select the proper result for atan(sin_in/cos_in)
*/

	/*************** Your code here ***************/
	//for arctan setting z[0] as 0
	data_t xi[N];
	data_t yi[N];
	data_t zi[N];
