...
#
# Script generated by Vivado on Thu Feb 15 12:18:04 -0600 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : datatrans_sys.sh
...
#
# Usage        : datatrans_sys.sh
#                datatrans_sys.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                datatrans_sys.sh [-reset_run]
#                datatrans_sys.sh [-reset_log]
#                datatrans_sys.sh [-help]
#
...
#                script (type 'datatrans_sys.sh -help' for more information).
#
...
# script info
echo -e "datatrans_sys.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./datatrans_sys.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../base.gen/sources_1/bd/datatrans_sys/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../base.gen/sources_1/bd/datatrans_sys/ipshared/aed8/hdl" +incdir+"../../../../base.gen/sources_1/bd/datatrans_sys/ipshared/ec67/hdl" +incdir+"../../../../base.gen/sources_1/bd/datatrans_sys/ipshared/aed8/hdl" +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.datatrans_sys xil_defaultlib.glbl -o datatrans_sys_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./datatrans_sys_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key datatrans_sys_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc datatrans_sys_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./datatrans_sys.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: datatrans_sys.sh [-help]\n\
Usage: datatrans_sys.sh [-step]\n\
Usage: datatrans_sys.sh [-lib_map_path]\n\
Usage: datatrans_sys.sh [-reset_run]\n\
Usage: datatrans_sys.sh [-reset_log]\n\
Usage: datatrans_sys.sh [-keep_index]\n\
Usage: datatrans_sys.sh [-noclean_files]\n\n\
