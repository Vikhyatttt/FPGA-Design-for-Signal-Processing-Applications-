...
#
# Script generated by Vivado on Fri Oct 31 16:54:21 CDT 2025
...
# script info
echo -e "blk_mem_gen_2.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"/opt/coe/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"/opt/coe/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work blk_mem_gen_v8_4_6 $vlogan_opts +v2k +incdir+"/opt/coe/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"/opt/coe/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/grads/t/tamu_vik/ECEN-722/lab7/lab7_base/base/base.cache/compile_simlib/vcs"
  fi
