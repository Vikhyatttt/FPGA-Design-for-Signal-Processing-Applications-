...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"/opt/coe/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"/opt/coe/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work blk_mem_gen_v8_4_6 $xmvlog_opts +incdir+"/opt/coe/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"/opt/coe/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/grads/t/tamu_vik/ECEN-722/lab7/lab7_base/base/base.cache/compile_simlib/xcelium"
  fi
