...
hufftable[7:0]=0;  //1, 0       UB=0                      0
hufftable[15:8]=2;   //2, 2     UB=2                      10
hufftable[23:16]=1;   //3, 3    UB=10<<1+1=100+1=5        101
hufftable[31:24]=3;    //4, 6   UB=101<<1+3=1010+11=13    1101
hufftable[39:32]=3;           //UB=26+3=29                
hufftable[47:40]=2;           //UB=58+2=60
hufftable[55:48]=4;
hufftable[63:56]=3;
hufftable[71:64]=5;
hufftable[79:72]=5;
...
huffsymbol[7:0]=1;     //01
huffsymbol[15:8]=2;    //10
huffsymbol[23:16]=3;   //011
huffsymbol[31:24]=0;   //0000
huffsymbol[39:32]=4;   //0100
huffsymbol[47:40]=17;  //0001
huffsymbol[55:48]=5;
huffsymbol[63:56]=18;
huffsymbol[71:64]=33;
huffsymbol[79:72]=49;
