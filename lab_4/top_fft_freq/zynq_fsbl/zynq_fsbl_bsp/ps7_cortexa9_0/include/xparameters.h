...
/* Definitions for driver TRANS */
#define XPAR_TRANS_NUM_INSTANCES 1

/* Definitions for peripheral TRANS_0 */
#define XPAR_TRANS_0_DEVICE_ID 0
#define XPAR_TRANS_0_S00_AXI_BASEADDR 0xFFFFFFFF
#define XPAR_TRANS_0_S00_AXI_HIGHADDR 0x00000000
